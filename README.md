...
* Digit-Doubles (d-key) shows houses with 2 or fewer occurrences of a given digit.
...
A logical sequence of new singletons followed by the resulting deletions is
...
which are in the same box, row or column.
